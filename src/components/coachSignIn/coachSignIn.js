...
class coachSignIn extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      email:'',
  ...
  handleSubmit = () => {
    ...
    render(){
        ...
        <div class="large-5 small-12 large-centered columns form-border signup_form border-bottom-radius-0">
          <h4 id="panel_header">COACH SIGN IN</h4>
          <div id="form-signin">
        <div class="margin-bottom-30 margin-top-10">You'll never do the same workout twice</div>
          ...
          <div class="row collapse">
            ...
            <div class="small-12 large-12 columns">
              <div class="field">
              <input className="form-control" onChange={(e) => this.setState({email: e.target.value})} placeholder="Enter email address" type="email" />              </div>
            </div>
          </div>
          ...
          <div class="row collapse">
            ...
            <div class="small-12 large-12 columns">
              <div class="field">
              <input className="form-control" onChange={(e) => this.setState({password: e.target.value})} placeholder="Enter password" type="password" />              </div>
            </div>
          </div>
        ...
        <div className="large-5 small-12 large-centered columns form-border signup_form border-top-radius-0 form-footer-part">
          <br />
        <Link to="/forgot-password/?type=coach" class="text-center">Forgot password?</Link>
        <br />
        <br />
